...
public class ProcessSQL {
   ...
   * @return JSONArray.
   * @exception UserNotExistsException On username not exist error.
   * @exception PasswordErrorException On password wrong error.
   */	
   ...
   * @param password password of the account.
   * @return Nothing.
   * @exception UserAlreadyExistsException On duplicate username error.
   * @exception DatabaseInsertFailException On insert data to database error.
   */
