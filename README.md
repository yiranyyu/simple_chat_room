...
# compile
javac -encoding utf8 -cp "./src;$jar_path" -d out ./src/User.java ./src/Message.java ./src/MessageDB.java  ./src/ProcessSQL.java ./src/API.java ./src/Server.java ./src/Client.java ./src/LoginPanel.java
